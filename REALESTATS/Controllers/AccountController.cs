...
namespace REALESTATS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = await SignInManager.PasswordSignInAsync(model.NumeroTelephone, model.Password, model.RememberMe, shouldLockout: false);
            switch (result)
            {
        ...
        {
            ViewBag.listRoles = busAdmin.GetAllRoles();
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.NumeroTelephone };
